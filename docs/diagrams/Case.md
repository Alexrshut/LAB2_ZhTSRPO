# :paperclip: __Диаграмма вариантов использования__

![Диаграмма вариантов использования](https://github.com/Alexrshut/LAB2_ZhTSRPO/blob/main/docs/diagrams/Case/MyCase.png) 

___
  
# :notebook: __Глоссарий__

| __Термин__ | __Определение__ |
|:--|:--|
| __Пользователь__ | Человек, использующий приложение |
| __Зарегистрированный__ пользователь | Пользователь, ранее зарегистрировавшийся в приложении |
| __Посетитель__ | Пользователь, использующий приложение без авторизации |  
| __Администратор__ | Работник компании, который добавляет новые рейсы |  
...
2. [Варианты использования](#use_case)
   ...
   2.3 [Выбор критериев для поиска](#see_products)

   2.4 [Выйти из аккаунта](#signout)

   2.6 [Удалить рейс](#delete_product)

   2.7 [Добавить рейс](#add_product)

   2.8 [Просмотреть историю покупок](#see_history_buy)
   
   2.9 [Купить рейс](#purchase_product)
...
| Администратор | Работник компании, который добавляет новые рейсы |  
...
#### 2.3 Выбор критериев для поиска

**Описание.** Любой пользователь может выбрать критерии.  
**Предусловия.** Пользователь нажал на кнопку "Поиск".  
**Основной поток.**
1. Приложение отображает критерии и окно поиска;
2. Пользователь выбирает все критерии.
...
**Основной поток.**
1. Приложение удаляет рейс из списка и базы данных;
2. Вариант использования завершается.
...
3. Приложение отображает информацию о рейсе;
4. Вариант использования завершается.
